...
cp "$REPO_ROOT/core/skills/init/SKILL.md"     "$EXTENSION_DIR/skills/init/SKILL.md"
cp "$REPO_ROOT/core/skills/sync/SKILL.md"     "$EXTENSION_DIR/skills/sync/SKILL.md"
cp "$REPO_ROOT/core/skills/validate/SKILL.md" "$EXTENSION_DIR/skills/validate/SKILL.md"
cp "$REPO_ROOT/core/templates/local-install/README.md"    "$EXTENSION_DIR/templates/local-install/README.md"
cp "$REPO_ROOT/core/templates/local-install/manifest.yml" "$EXTENSION_DIR/templates/local-install/manifest.yml"
